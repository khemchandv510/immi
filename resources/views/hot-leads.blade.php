 ...
 <div class="container-fluid" style="padding:0">
    ...
    ></button> 
          ...
          <div class="row list-page-top-link panel" >
            ...
            if( Auth::user()->usertype_status =='1'){
              ?>
               {{-- <a href={{ url('assigned-hot-leads') }}><li><i class="fas fa-user-tie"></i> Assigned Client  </li></a>  --}}


               <a href="#"><li><i class="fas fa-angle-left "></i> <span style="color:#54ec15">  <?php 
               echo  $a =  DB::table('mbbsgo')->where('status',1)->count('id') 
               ; ?></span> Lead Remaining </li></a>
              

              
          <a data-toggle="modal" data-target="#import_hot_leads" aria-hidden="true" style="color:#fff;cursor:pointer">
                <li> <i class="fas fa-file-import"></i> 
                  Import Hot Leads
              </li>
            </a>  
              {{-- <a href="#"><li><i class="fas fa-angle-left "></i>  Lead Remaining </li></a> --}}
...
{{--                     
                      ...
                      {{-- import excell modal --}}
                      <div class="modal" id="import_hot_leads">
                        <div class="modal-dialog">
                          <div class="modal-content">
                          
                            <!-- Modal Header -->
                            <div class="modal-header">
                              <h4 class="modal-title">Import Hot Leads</h4>
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            ...
                            <div class="modal-body">
                              ...
                              <p >{{ Session::get('message') }}</p>
                              @endif
                              <form method='post' action={{url(Request::segment(1).'/'.'import-hot-leads')}} enctype='multipart/form-data' >
                                {{ csrf_field() }}
                                <div class="custom-file">
                                  <input type="file" class="custom-file-inpu" id="customFil" name="import_client">
