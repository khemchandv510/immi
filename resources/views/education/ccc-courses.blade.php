...
<script>
      ...
      <a class="btn btn-danger" href="{{url('admin/education/dashboard')}}" style="    text-align: right;
      position: absolute;
...
{{Form::close()}}
    ...
    @endif
                ...
                <?php
                 ...
                 $courses  = courses::where('college_code',$code)->get();
                         // dd($courses);
...
<tr>
    ...
    <a href="{{ url('admin/education/course-additional-info/'.$courses->id) }}">  {{$courses->course_name}}</a>
    </td>
      ...
      var l =   a.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
       $('.app_fees{{$courses->unique_id}}').text(l);
                                  ...
                                  <td>
                                    ...
                                    {{-- <button type="button" class="btn-danger" data-toggle="modal" data-target="">  --}}
                                      <a class="fa fa-pencil-square-o" href="{{url('admin/education/update-course/'.$courses->id)}}">
                                    </a>
                                   {{-- </button> --}}
                                    {{-- <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2">Open Modal</button> --}}
