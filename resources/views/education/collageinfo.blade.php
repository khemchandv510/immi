...
<div class="row college-detail-page">
  <div class="col-sm-3 sort-info immigration"  >
        <div>
...
<div>
     ...
     <a href="{{url('admin/education/courses/'.$info2->code)}}" > <button   class="find-program">
     Courses     </button  >  </a>

 
  <button class="find-program"> <a href="{{url('admin/education/dashboard')}}" style="color:#fff"> Universities / Institutes </a> </button>
...
<a href="{{url('admin/education/update-institution/'.Crypt ::encrypt($info2->name))}}"   > <button    class="find-program"> Update Institution    </button> </a>
@endforeach
@endif

<a data-toggle="modal" data-target="#CourseDeleteModel"> <button    class="find-program">Delete Institute With Courses</button> </a>

<!--<a href=""  data-toggle="modal" data-target="#modalCourse"> -->
<!--<button  class="find-program"  >Import Courses</button> </a>-->
</div>
...
<!-- Modal -->
<div class="modal fade" id="CourseDeleteModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <p style="color:red;"> You are Going to Delete  ({{$info2->name}}) with all courses. </p> 
       </br>
       <p style="color:red;"> If You are agree with click on below Delete button</p> 
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-danger"> <a href="{{url('admin/education/DeleteIntCourses/'.Crypt ::encrypt($info2->code))}}">Delete </a> </button>
      </div>
    </div>
  </div>
</div>
  ...
  {{-- stat column --}}
    <div class="col-sm-9">
          <div>
              <ul class="menu enquiry-test-list"> 
                <li><p><a href="#about" style="color: #ffffff;"> <i class="fas fa-address-card" style="width:35px !important"></i> About  </a> </p> </li>
                <li> <p> <a href="#locati" style="color: #ffffff;"> <i class="fab fa-centercode" style="width:35px !important"></i> Gallery </a> </p> </li>  
                <li> <p> <a href="#location" style="color: #ffffff;"> <i class="fas fa-street-view" style="width:35px !important"></i> Location </a> </p> </li>
                <li> <p> <a href="#program" style="color: #ffffff;"> <i class="fab fa-audible"></i> Programs </a> </p> </li>
                <li> <p> <i class="fas fa-phone-volume"></i> Contacts</p> </li>
                <!--<li> <p><i class="fas fa-location-arrow" style="width:35px !important"></i> Campus</p> </li>-->
                <!--<li> <p><i class="far fa-clipboard" style="width:35px !important"></i>Notes</p> </li>-->
                <li> <p><i class="far fa-file-word" style="width:35px !important"></i>Doc</p> </li>
              </ul>
          </div>
...
<div class="background-css"  id="location" >
  <h4>Location</h4>
<img src="{{url('public\uploads\university-map\map.png')}}" width="100%" alt="">
</div>
...
$a = 1;
?>
<h4 style=" margin-top: 12px; background-color: #34495e; color: #fff; padding: 11px;">Programs  <span> {{$a}} </span> </h4>  
<div style="overflow: auto;
max-height: 1000px;">
@foreach($get_courses as $get)

<div class="background-css-parent">   
    <div class="row background-css"  id="program" >
        
      <div class="col-md-6 col-sm-12 progrem-desc w-100">
         

          <p class="program-name"> 	
            {{$get->course_name}}</p>
          <p class="degree" style="text-align: inherit;"> {{$get->duration_year}} </p>
        ...
        <div class="col-md-6 col-sm-12 eligibility w-100" style=" overflow-x: scroll; ">
          <h5>Eligibility</h5>
            ...
            <div class="english-language-test" style="margin-top: 10px;">
               <p>  TOFEL </p>
               <table>
               ...
               <p style="margin-top: 10px;">  IELTS </p>
               <table>
                 <tr style=" background-color: #34495e; color: #fff; ">
                   <th>Reading</th> <th>Wriing</th> <th>Speaking</th> <th>Listening</th>
                 </tr>
