...
<div class="row list-page-top-link">
  ...
  <div class="col-md-9"> 
    ...
    <ul class="enquiry-test-list">
      ...
      <li> 
        <a href="{{url(Request::segment(1).'/education/add-institution')}}"><i class="fas fa-plus"></i> Add Institution</a>
      </li>
      <li> 
        <a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-cloud-upload" aria-hidden="true"></i> Import Universities</a>
      </li>
      <li>
        <a href=""  data-toggle="modal" data-target="#modalCourse"> 
        <i class="fa fa-cloud-upload" aria-hidden="true"></i>
        <button  class="btn find-program"  style="color:#fff">Import Courses</button> </a>
      </li>
      @endif
    {{--  <li> 
        <a href="{{url('education/dashboard')}}"><i class="fa fa-cloud-upload" aria-hidden="true"></i> Get All College</a>
      </li>
      <li> 
        <a href="{{url('filter-course-section')}}"><i class="fa fa-filter"></i>Filter</a>
      </li> --}}
      
      <li>
          <a href=""  data-toggle="modal" data-target="#modalCourseImageUpload"> 
        <i class="fa fa-cloud-upload" aria-hidden="true"></i>
        <button  class="btn find-program"  style="color:#fff">Bulk Import Universities Logo</button> </a>
        </li>
    </ul>
  </div>

  <div class="col-md-3">
    <form action="{{url(Request::segment(1).'/search-university')}}" method="get" style="position:relative"><input type="text" name="searchUniversity" class="form-control" placeholder="Search "> <button type="submit" name="" class="btn btn-danger w-10 fa fa-search" id="filter_button" style="    position: absolute;
      top: 0px;
      right: 0px;
      outline: none;
      padding: 4px;
...
{{-- kaushik End --}}
                {{-- old <div class="row edu-dash-top-btn">
                    ...
                    <div class="col-m2  ">
                     <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal"><i class="fa fa-cloud-upload" aria-hidden="true"></i> Import University</button>
                    </div>
                    <div class="col-d-2  ">
                       ...
                       <div class="col-d-2  ">
                        <button type="button" class="btn btn-danger"  >
                          ...
                          <a class="collapse-item" href="{{url('filter-course-section')}}">Filter</a>
                        </button>
                       ...
                       <div class=" col-sm-">
                          ...
                          <div >
                        <form action="{{url('search-university')}}" method="get" style="position:relative"><input type="text" name="searchUniversity" class="form-control" placeholder="Search "> <button class="fa fa-search" style="position: absolute;
                          right: 4px;
    ...
    <div class="">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Import University</h4>
...
Import CSV file to upload University. The file must be a provided formate...
<br> 
          ...
          <form method='post' action="{{url(Request::segment(1).'/uploadFile')}}" enctype='multipart/form-data' >
            {{ csrf_field() }}
            <div class="custom-file">
              <input type="file" class="form-control custom-file-inpu" id="customFil" name="file" style="margin-top: 10px;">
...
<div class="person__pic">
                          <img src="{{url('public\uploads\university-logo/').$edu2->logo}}" alt="">
...
<script type="text/javascript">
          ...
          callback: function() {
           ...
           {{-- @dd($my_institutes); --}}
                ...
                {{-- <div class="ajax-loading  fa fa-refresh" ></div> --}}
                  ...
                  <a href={{url(Request::segment(1).'/education/collage-info/'.$edu2->code )}} style="color:unset; display: contents;" class="ancher-link"> 
              

    
                                <div class="search-list__item ">
                                  <div class="person">
                                    <div class="person__header test">
                                      <div class="person__title-container">
                                        <h3 class="person__name"> {{$edu2->name}} </h3>
                                        <h4 class="person__title"> 
                                            <span class="fa fa-map-marker" >  </span>
 ...
 <div class="person__pic " >
  ...
  @if($edu2->logo != "")
  <img src="{{url('public\uploads\university-logo').'/'.$edu2->logo}}" alt="image" >
  @else
  
  <img src="{{url('public\uploads\university-logo/default-logo.jpg')}}" alt="" >
  @endif
                                      {{-- <span class="fa fa-university"></span> --}}
                                      <span class="fa fa-book"> 
                                          <?php 
...
// })
 ...
 <div class="modal" id="programm_filter" style="padding-top:0;">
    ...
    <div class="modal-dialog" style="width:1200px;max-width:1200px;top: 7%;
    position: absolute;
    left: 50%;
    transform: translate(-50%);">
      <div class="modal-content" style="width:100% !important;">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
            <input type="reset" id="reset_elegibility_filter">
        ...
        <div class="modal-body" style="position:relative;width: 80%;margin: auto;">
              ...
              <div class="stepwizard col-md-offset-3">
                ...
                <div class="row setup-content"  id="start">
                  ...
                  <script> 
                      $('#reset_elegibility_filter').click(function(){
                         $(".selectpicker").val('default').selectpicker("refresh");
                      })
                             </script>
                
                      
                      <div class="form-group col-sm-6  select-student" style="position:relativ">
                      <label class="label-clas">Student  </label>
                      </div>
...
<div class="col-sm-6">
          ...
          <select id="students_select"    name="students_select" class="selectpicker form-control " data-live-search="true"  onChange="get_university(this.value);check_empty_country();" style="    position: absolute;
          width: 50%;
          right: 25px;">
...
<div class="col-sm-6 form-group"> Study Country <span class="star">*</span> </div>
<div class="col-sm-6 form-group"> 
  <select name="" id="study_country" class="form-control selectpicker">
    <option selected disabled> --Select Country--  </option>
    <option value="Canada"> Canada  </option>
    <option value="USA">   USA  </option>
    <option value="Australia">   Australisa  </option>
  </select>
</div>
...
<div class="col-sm-6 select-student form-group" >
University / Institutes 
</div> 

<div class="col-sm-6 form-group" id="college_country_parent">
    <select name="enrolment_college[]" id="college_country" class=" form-control selectpicker select-college-courses" data-live-search="true" multiple  onChange="getcourses(this.value);" selectAllText="true">
      <option  disabled> --Select Universities / Institutes-- </option>
...
//   multiple_id.push(val);
  
// console.log(multiple_id);


// $.ajax({
//   type: "get",
//   url: "{{url('getcourses')}}?id="+multiple_id,
//   success: function(data){
//     alert(data)
      // $('#state-list').empty();
...
<button id="next_button2"  class=" next_button_country btn btn-primary nextBtn btn-lg " type="button" >Next</button>
                  ...
                  <div class="row setup-content" id="step-2">
                    <div class="col-sm-12"> <p style="font-size:27px">  English Language Test </p> <hr> </div>
                      {{-- <div class=" col-sm-6 ">
...
{{-- <div class="col-sm-3"></div>
                                            <div class="col-sm-5"></div> --}}
                                                ...
                                                <div class="row toefl_score_show" id="toefl_score">
                                                   
                                               <div class="col-sm-12">
                                                  <p> TOEFL </p>
                                                  <p>
                                               <span>    <input type="number" placeholder="Reading" name="toefl_reading">   </span>
                                                   <span>   <input type="number" placeholder="Writing" name="toefl_writing">   </span>
                                                   <span>    <input type="number" placeholder="Listening" name="toefl_listening">  </span>
                                                   <span>       <input type="number" placeholder="Speaking" name="toefl_speaking"> </span>
                                                  </p>
...
The given formate must be use to import courses list...  
            ...
            {{ Form::open(array('url' => '/admin/education/upload-course','files'=>'true')) }}
...
<!-- =================   Universities logo model =======-->

<div class="modal fade" id="modalCourseImageUpload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{url('/admin/education/universitylogo')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            
          <div class="form-group">
            <label for="exampleFormControlFile1">Select Logo files</label>
            <input type="file" class="form-control-file" id="exampleFormControlFile1" name="image[]" multiple="multiple" required>
              <input class="btn btn-danger mt-3" name="universitylogo" type="submit" value="submit">
          </div>
        </form>
...
<select class="selectpicker" multiple name="intake[]">
    <option value="{{'Jan '.$date}}">{{'January '.$y1}}</option>
              <option value="{{'Feb '.$y1}}">{{'February '.$y1}}</option>
              <option value="{{'Mar '.$y1}}">{{'March '.$y1}}</option>
              <option value="{{'Apl '.$y1}}">{{'April '.$y1}}</option>
              <option value="{{'May '.$y1}}">{{'May '.$y1}}</option>
              <option value="{{'Jun '.$y1}}">{{'June '.$y1}}</option>
              <option value="{{'Jul '.$y1}}">{{'July '.$y1}}</option>
              <option value="{{'Aug '.$y1}}">{{'August '.$y1}}</option>
              <option value="{{'Sep '.$y1}}">{{'September '.$y1}}</option>
              <option value="{{'Oct '.$y1}}">{{'October '.$y1}}</option>
              <option value="{{'Nov '.$y1}}">{{'November   '.$y1}}</option>
              <option value="{{'Dec '.$y1}}">{{'December '.$y1}}</option>

              <option value="{{'Jan '.$y2}}">{{'January '.$y2}}</option>
              <option value="{{'Feb '.$y2}}">{{'February '.$y2}}</option>
              <option value="{{'Mar '.$y2}}">{{'March '.$y2}}</option>
              <option value="{{'Apl '.$y2}}">{{'April '.$y2}}</option>
              <option value="{{'May '.$y2}}">{{'May '.$y2}}</option>
              <option value="{{'Jun '.$y2}}">{{'June '.$y2}}</option>
              <option value="{{'Jul '.$y2}}">{{'July '.$y2}}</option>
              <option value="{{'Aug '.$y2}}">{{'August '.$y2}}</option>
              <option value="{{'Sep '.$y2}}">{{'September '.$y2}}</option>
              <option value="{{'Oct '.$y2}}">{{'October '.$y2}}</option>
              <option value="{{'Nov '.$y2}}">{{'November   '.$y2}}</option>
              <option value="{{'Dec '.$y2}}">{{'December '.$y2}}</option>

              <option value="{{'Jan '.$y3}}">{{'January '.$y3}}</option>
              <option value="{{'Feb '.$y3}}">{{'February '.$y3}}</option>
              <option value="{{'Mar '.$y3}}">{{'March '.$y3}}</option>
              <option value="{{'Apl '.$y3}}">{{'April '.$y3}}</option>
              <option value="{{'May '.$y3}}">{{'May '.$y3}}</option>
              <option value="{{'Jun '.$y3}}">{{'June '.$y3}}</option>
              <option value="{{'Jul '.$y3}}">{{'July '.$y3}}</option>
              <option value="{{'Aug '.$y3}}">{{'August '.$y3}}</option>
              <option value="{{'Sep '.$y3}}">{{'September '.$y3}}</option>
              <option value="{{'Oct '.$y3}}">{{'October '.$y3}}</option>
              <option value="{{'Nov '.$y3}}">{{'November   '.$y3}}</option>
              <option value="{{'Dec '.$y3}}">{{'December '.$y3}}</option>
</select>
...
$(document).ready(function(){
  $('.select-college-courses').change(function(){
    var unique_id = $(this).val();
       
var url = "{{url('getcourses')}}?a="+unique_id;
$.ajaxSetup({
                  headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
              }
...
var url = "{{url('get_student_detail')}}?a="+unique_id;
$.ajaxSetup({
                  headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
              }
  ...
  //  alert(this.reading);
  var a =  this.reading;
  $('#highest_educations').empty();
  $('#highest_educations').append('<option value="'+this.class+'"> '+this.class+'</option>');
  $('#grade_average').empty();
  $('#grade_average').val(this.percentage);
   if(a == null){
  return false;
   }
   
    $('#toefl_score').append(' <div class="col-sm-12"> <p> '+this.language+' </p> <p> <span> <input type="text" value"'+this.reading+'">  <input type="hidden"  name="'+this.language+'_reading" value="'+this.reading+'"> </span> <span> <input type="text" value="'+this.writing+'">  <input type="hidden" name="'+this.language+'_writing" value="'+this.writing+'"> </span> <span> <input type="text" value="'+this.speaking+'"> <input type="hidden"  name="'+this.language+'_speaking" value="'+this.speaking+'"> </span> <span>  <input type="text" value="'+this.listening+'">  <input type="hidden"  name="'+this.language+'_listening" value="'+this.listening+'"> </span> </p></div>');
...
<script>
$(document).ready(function(){
  $('#study_country').change(function(){
    var unique_id = $(this).val();
          var url = "{{url('get_institutes')}}?a="+unique_id;
          $.ajaxSetup({
                            headers: {
                          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        }
                ...
                type: "GET",
                  ...
                  success: function(data) {
            // alert(data);
                    // $('#college_country_parent').empty();
            $.each(data, function(key, value){
            
            // $('#college_country').append('<option value="'+this.code+'"> '+this.name+'</option>');
            });
                  }
              });
...
$('#toefl_score').append(' <div class="col-sm-12"> <p> TOEFL </p><p> <span> <input type="number" placeholder="Reading" name="toefl_reading"> </span> <span> <input type="number" placeholder="Writing" name="toefl_writing"> </span> <span> <input type="number" placeholder="Listening" name="toefl_listening"> </span> <span> <input type="number" placeholder="Speaking" name="toefl_speaking"> </span> </p></div><div class="col-sm-12"> <p>IELTS</p><p> <input type="number" placeholder="Reading" name="ielts_reading"> <input type="number" placeholder="Writing" name="ielts_writing"> <input type="number" placeholder="Listening" name="ielts_listening"> <input type="number" placeholder="Speaking" name="ielts_speaking"> </p></div>');

    var url = "{{url('get_high_edu_toefl')}}";
          $.ajaxSetup({
                            headers: {
                          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        }
                ...
                type: "GET",
                  ...
                  success: function(data) {
                    $('#highest_educations').empty();
                    $.each(data, function(key, value){
                      $('#highest_educations').append('<option value="'+this.education+'"> '+this.education+'</option>');
