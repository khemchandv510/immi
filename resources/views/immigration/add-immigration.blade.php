...
<center><h2 class="text-primary mx-4">Add Institute</h2></center>

<div class="container">
          <form method ="post" action ="{{route('add-immigration-save')}}">
            @csrf
              ...
              <div class="form-row col-md-4">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fas fa-comment"></i></span>
                          ...
                          <textarea class="form-control" name="comment" cols="10" rows="2" style="resize:none;"></textarea></div>
