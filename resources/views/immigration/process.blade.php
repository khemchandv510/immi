         ...
         <!-- content page 1 -->
          <div style="display: grid;grid-template-columns: 1fr 1fr;padding: 2rem 0;">
            <div style="padding: 1rem;border-right: 1px solid #c6c6c6;">
                ...
                <!-- 1) -->
                <div>
                    <p style="margin-top: 1rem;"><b>1) </b> Are you notifying the Department that you have been appointed to 
                        provide immigration assistance, or that your appointment has ended?</p>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>New appointment (<span>&#10003;</span>) - </p> <p style="margin-left: 1rem;"><b style="display: block;">Complete Part A and Part C</b><span>You do not need to complete Part B</span> </p></div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>Appointment has ended ( ) - </p> <p style="margin-left: 1rem;"><b style="display: block;">Complete Part B and Part C</b><span>You do not need to complete Part A</span> </p></div>
                </div>
                ...
                <!-- 2) -->
                 <div style="margin-top: 2rem;">
                    ...
                    <p style="display: flex;gap: 1rem;margin-top: 1rem;margin-left: 1rem;"><span style="margin-right: 1rem;">Title:</span><span>Mr</span><span>(&#10003;)</span><span>Mrs</span><span>( )</span><span>Miss</span><span>( )</span><span>Ms</span><span>( )</span><span>Other</span><span>( )</span></p>
                    <p style="margin-top: 1rem;margin-left: 1rem;">Family Name: <span>Ram Kushwaha</span></p>
                    <p style="margin-top: 1rem;margin-left: 1rem;">Given Name: <span>Ram Kushwaha</span></p>
                    <p style="margin-top: 1rem;margin-left: 1rem;">Exempt person’s date of birth: <span>24-02-2000</span></p>
                 </div>

                <!-- 3) -->
                 <div style="margin-top: 2rem;">
                    <p style="margin-top: 1rem;"><b>3) </b>Organisation name (if applicable): <span>Kliff Technologies Pvt Ltd</span></p>
                 </div>

                <!-- 4) -->
                 <div style="margin-top: 2rem;">
                    <p style="margin-top: 1rem;"><b>4) </b>Business or residential address: <span>RX-B- 345, XYZ Mor, Fruit Market</span></p>
                    <p style="margin-top: 1rem;margin-left: 1rem;"></b>Postcode: <span>110075</span></p>
                 </div>

                <!-- 5) -->
                 <div style="margin-top: 2rem;">
                    <p style="margin-top: 1rem;"><b>5) </b>Address for correspondence: <span>RX-B- 345, XYZ Mor, Fruit Market</span></p>
                    <p style="margin-top: 1rem;margin-left: 1rem;"></b>Postcode: <span>110075</span></p>
                 </div>
                ...
                <!-- 6) -->
                 <div style="margin-top: 2rem;">
                    ...
                    <p style="display: flex;gap: 1rem;margin-top: 1rem;margin-left: 1rem;"><span style="margin-right: 1rem;">Office hours:</span><span>Country Code:</span><span>(+91)</span><span>Area Code:</span><span>(11)</span><span>Number:</span><span>(25949759)</span></p>
                    <p style="margin-top: 1rem;margin-left: 1rem;"></b>Mobile/cell: <span>9540224567</span></p>
                 </div>
            </div>
            ...
            <div style="padding: 1rem;margin-left: 1rem;">
                <!-- 7) -->
                <div>
                    <p><b>7) </b> Do you agree to the Department communicating with you by email 
                        or other electronic means?</p>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>No (<span>&#10003;</span>)</p> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>Yes ( ) - </p> <p style="margin-left: 1rem;"><span>Give Details</span> </p></div>
                    <p style="margin-top: 1rem;margin-left: 1rem;"></b>Email address: <span>xyz@gmail.com</span></p>
                </div>

                <!-- 8 -->
                <div style="margin-top: 2rem;">
                    <p><b>8) </b> In what capacity are you providing assistance?</p>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>Registered migration agent (<span>&#10003;</span>) - </p> <p style="margin-left: 1rem;"><span>Go to Question 9</span> </p></div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>Legal practitioner ( ) - </p> <p style="margin-left: 1rem;"><b style="display: block;">Go to Question 9</b> </p></div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>Exempt person ( ) - </p> <p style="margin-left: 1rem;"><b style="display: block;">Go to Question 11</b> </p></div>
                </div>

                <!-- 9) -->
                <div style="margin-top: 2rem;">
                    <p style="margin-top: 1rem;"><b>9) </b>Migration Agent Registration 
                        Number (MARN): <span>958457886524</span></p>
                    <p style="margin-top: 1rem;margin-left: 1rem;"></b>Legal Practitioner Number (LPN): <span>11007556428</span></p>
                </div>
                ...
                <div style="margin-top: 2rem;">
                    ...
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>No (<span>&#10003;</span>) - </p> <p style="margin-left: 1rem;"><b style="display: block;">Go to Question 12</b> </p></div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>Yes ( ) - </p> <p style="margin-left: 1rem;"><span>Give details of the other registered migration agent/legal 
                        practitioner</span> </p></div>
                    <p style="margin-top: 1rem;margin-left: 1rem;">Family Name: <span>Ram Kushwaha</span></p>
                    <p style="margin-top: 1rem;margin-left: 1rem;">Given Name: <span>Ram Kushwaha</span></p>
                ...
                <!-- 11 -->
                 <div style="margin-top: 2rem;">
                    ...
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Close family member (spouse, child, parent, brother or sister)</p><span>(<b>&#10003;</b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Sponsor</p><span>(<b> </b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Nominator</p><span>(<b> </b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Member of a diplomatic mission, consular
                        post or international organisation</p><span>(<b> </b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Member of parliament or their staff</p><span>(<b> </b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Official appointed or engaged under the Public Service Act 1999
                        or member of state/territory public services giving immigration 
                        assistance as part of their duties</p><span>(<b>&#10003;</b>)</span> </div>
                 </div>
          ...
          <!-- content page 2 -->
           <div style="display: grid;grid-template-columns: 1fr 1fr;padding: 2rem 0;">
                ...
                <!-- -----   -->
                    ...
                    <!-- 12 -->
                    <div style="margin-top: 2rem;">
                        <p><b>12) </b> The person receiving immigration assistance (ie. the client) is a: (tick one only)</p>
                        <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Visa applicant</p><span>(<b>&#10003;</b>)</span> </div>
                        <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Sponsor or sponsor applicant</p><span>(<b> </b>)</span> </div>
                        <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Nominator or nominator applicant</p><span>(<b> </b>)</span> </div>
                        <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Proposer or proposer applicant</p><span>(<b> </b>)</span> </div>
                        <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Visa holder whose visa is being considered for 
                            cancellation or has been cancelled</p><span>(<b> </b>)</span> </div>
                        <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p>Person requesting ministerial intervention</p><span>(<b>&#10003;</b>)</span> </div>
                    </div>
                    ...
                    <!-- 13 -->
                     <div style="margin-top: 2rem;">
                        ...
                        <p style="margin-top: 1rem;margin-left: 1rem;">Family Name: <span>Ram Kushwaha</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Given Name: <span>Ram Kushwaha</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Date of birth: <span>24-02-2000</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Organisation name (if applicable): <span>Kliff Technologies Pvt Ltd</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Business or residential address: <span>RX-B- 345, XYZ Mor, Fruit Market</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Telephone numbers:</p>
                        <p style="display: flex;gap: 1rem;margin-top: 1rem;margin-left: 1rem;"><span style="margin-right: 1rem;">Office hours:</span><span>Country Code:</span><span>(+91)</span><span>Area Code:</span><span>(11)</span><span>Number:</span><span>(25949759)</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;"></b>Mobile/cell: <span>9540224567</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;"></b>Department of Home Affairs
                            Client ID number (if known): <span>9540224567</span></p>
                     </div>
                    ...
                    <!-- 14 -->
                     <div style="margin-top: 2rem;">
                        ...
                        <div style="margin-bottom: 1rem;">
                            <p style="margin-top: 1rem;margin-left: 1rem;">1. Family Name: <span>Ram Kushwaha</span></p>
                            <p style="margin-top: 1rem;margin-left: 2rem;">Given Name: <span>Ram Kushwaha</span></p>
                        </div>
                        <div style="border-top: 1px solid #c6c6c6;margin-bottom: 1rem;">
                            <p style="margin-top: 1rem;margin-left: 1rem;">2. Family Name: <span>Ram Kushwaha</span></p>
                            <p style="margin-top: 1rem;margin-left: 2rem;">Given Name: <span>Ram Kushwaha</span></p>
                        </div>
                        <div style="border-top: 1px solid #c6c6c6;margin-bottom: 1rem;">
                            <p style="margin-top: 1rem;margin-left: 1rem;">3. Family Name: <span>Ram Kushwaha</span></p>
                            <p style="margin-top: 1rem;margin-left: 2rem;">Given Name: <span>Ram Kushwaha</span></p>
                        </div>
                        <div style="border-top: 1px solid #c6c6c6;margin-bottom: 1rem;">
                            <p style="margin-top: 1rem;margin-left: 1rem;">4. Family Name: <span>Ram Kushwaha</span></p>
                            <p style="margin-top: 1rem;margin-left: 2rem;">Given Name: <span>Ram Kushwaha</span></p>
                        </div>
                        <div style="border-top: 1px solid #c6c6c6;margin-bottom: 1rem;">
                            <p style="margin-top: 1rem;margin-left: 1rem;">5. Family Name: <span>Ram Kushwaha</span></p>
                            <p style="margin-top: 1rem;margin-left: 2rem;">Given Name: <span>Ram Kushwaha</span></p>
                        </div>
                     </div>
                </div>
                ...
                <div style="padding: 1rem;">
                    ...
                    <div>
                        ...
                        <div>
                            <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p><b>Application </b>process (<span>&#10003;</span>)</p> </div>
                            <p style="margin-top: 1rem;margin-left: 3rem;">Type of Application: <span>xyz application</span></p>
                            <p style="margin-top: 1rem;margin-left: 3rem;">Date lodged: <span>24-08-2025</span></p>
                            <div style="display: flex;margin-top: 1rem;margin-left: 3rem;"><p>Not yet lodged ( )</p></div>
                        </div>
                        <div>
                            <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p><b>Cancellation </b>process (<span>&#10003;</span>)</p> </div>
                            <p style="margin-top: 1rem;margin-left: 3rem;">Subclass of visa: <span>xyz visa</span></p>
                            <p style="margin-top: 1rem;margin-left: 3rem;">Date lodged: <span>24-08-2025</span></p>
                        </div>
                        <div>
                            <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p><b>Specific matter</b> – give details (eg. sponsorship monitoring and 
                                sanction activity by the Department, or for only one stage of a two 
                                stage visa, ministerial intervention) (<span>&#10003;</span>)</p> </div>
                 ...
                 <div style="margin-top: 2rem;">
                    ...
                    <div style="margin-bottom: 1rem;">
                        <p style="margin-top: 1rem;margin-left: 1rem;">Department of Home Affairs 
                            Request ID number (RID): <span>9859364856</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Department of Home Affairs 
                            Transaction Reference Number 
                            (TRN): <span>8125876566</span></p>
                    </div>
                </div>
                ...
                <!-- 17) -->
                <div>
                    <p><b>17) </b> Have you been authorised to receive written communication on behalf 
                        of your client(s) in relation to the matter indicated in Question 15?</p>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>No (<span>&#10003;</span>) - </p> <p style="margin-left: 1rem;"><span>Go to Part C</span> </p></div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>Yes ( ) - </p> <p style="margin-left: 1rem;"><span>Go to Part C</span> </p></div>
                </div>
           ...
           <div style="display: grid;grid-template-columns: 1fr 1fr;padding: 2rem 0;">
                ...
                <!-- -----   -->
                    ...
                    <div style="margin-top: 2rem;">
                        ...
                        <p style="margin-top: 1rem;margin-left: 1rem;"></b>Migration Agent Registration 
                            Number (MARN): <span>9540224567</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;"></b>Legal Practitioner Number (LPN): <span>9540224567</span></p>
                     </div>

                    <!-- 19) -->
                    <div style="margin-top: 2rem;">
                        <p><b>19) </b> Was the person named at Question 18 also appointed as the client’s 
                            authorised recipient?</p>
                        <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>No (<span>&#10003;</span>) </p> </div>
                        <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>Yes ( ) </p> </div>
                        <p style="margin-top: 1rem;margin-left: 1rem;"><i>(if yes) </i>Is the client ending their appointment as authorised 
                            recipient?</p>
                    ...
                    <div style="margin-top: 2rem;">
                        ...
                        <p style="margin-top: 1rem;margin-left: 1rem;">Organisation name (if applicable): <span>Kliff Technologies Pvt Ltd</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Business or residential address: <span>RX-B- 345, XYZ Mor, Fruit Market</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Post Code: <span>110025</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Telephone numbers:</p>
                        <p style="display: flex;gap: 1rem;margin-top: 1rem;margin-left: 1rem;"><span style="margin-right: 1rem;">Office hours:</span><span>Country Code:</span><span>(+91)</span><span>Area Code:</span><span>(11)</span><span>Number:</span><span>(25949759)</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;"></b>Mobile/cell: <span>9540224567</span></p>
                     </div>
                     ...
                     <!-- 21 -->
                    <div style="margin-top: 2rem;">
                        <p><b>21) </b> Does the client agree to the Department communicating with them 
                            by email or other electronic means?</p>
                        <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>No (<span>&#10003;</span>)</p></div>
                        <div style="display: flex;margin-top: 1rem;margin-left: 1rem;"><p>Yes ( ) - </p> <p style="margin-left: 1rem;"><span>Give Details</span> </p></div>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Email Address: <span>xyz@gmail.com</span></p>
                    </div>
                </div>
                ...
                <div style="padding: 1rem;">
                    ...
                    <div style="margin-top: 2rem;">
                        ...
                        <p style="margin-top: 1rem;margin-left: 1rem;">Department of Home Affairs 
                            Request ID number (RID): <span>259498596</span></p>
                        <p style="margin-top: 1rem;margin-left: 1rem;">Department of Home Affairs 
                            Transaction Reference Number 
                            (TRN): <span>259498596</span></p>
                    </div>
          ...
          <!-- content page 4 -->
           <div style="display: grid;grid-template-columns: 1fr 1fr;padding: 2rem 0;">
                ...
                <div style="margin-top: 2rem;">
                    ...
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p><b>Appointment of registered migration agent / legal 
                        practitioner / exempt person</b> – I declare that I have been 
                        ...
                        on the client’s behalf as permitted by law.</p><span>(<b>&#10003;</b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p><b>Appointment of authorised recipient</b> – I understand that I have 
                        ...
                        in Question 7 (if applicable)</p><span>(<b> </b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p><b>Ending appointment of registered migration agent / legal 
                        practitioner / exempt person</b> – I declare that I am no longer 
                        acting on behalf of the client named in Part B and I have advised 
                        the client accordingly.</p><span>(<b> </b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p><b>Withdrawal of authorised recipient appointment</b> – 
                        I understand that I am no longer acting as authorised recipient in 
                        this matter.</p><span>(<b> </b>)</span> </div>
                    
                    <p style="margin-left: 1rem;margin-top: 1rem;"><b>Signature of registered migration agent/legal practitioner/
                        exempt person</b></p>
                    <img src="" alt="Signature img" style="margin-left: 1rem;margin-top: 2rem;">
                    <p style="margin-top: 1rem;margin-left: 1rem;">Date: <span>24-05-2025</span></p>
                ...
                <div style="margin-top: 2rem;">
                    ...
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p><b>Appointment of registered migration agent / legal 
                        practitioner / exempt person</b> – I declare that I have appointed 
                        ...
                        indicated on this form.</p><span>(<b>&#10003;</b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p><b>Appointment of authorised recipient</b> – I declare that I have 
                        ...
                        my behalf.</p><span>(<b> </b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p><b>Ending appointment</b> – I declare that the registered migration 
                        agent/legal practitioner/exempt person named in Part B is no 
                        longer acting on my behalf.</p><span>(<b> </b>)</span> </div>
                    <div style="display: flex;margin-top: 1rem;margin-left: 1rem;justify-content: space-between;"><p><b>Withdrawal of authorised recipient appointment</b> – 
                        I declare 
                        ...
                        correspondence.</p><span>(<b> </b>)</span> </div>
