...
?>
<td> 
        <input type="text" name="dob" value="{{date('d/m/Y', strtotime($get->dob))}}"class="form-control date">     
 </td>
<?php
}else{
?>
<td> <input type="text" name="dob" class="form-control date">    </td>
<?php
}
?>
...
//                               var a  = document.querySelectorAll('select[name="country"]')
//     var len = a.length
//     for(var i=0; i<len; i++){ 
