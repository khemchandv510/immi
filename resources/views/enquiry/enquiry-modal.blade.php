    ...
    transform: translate(0,-50%);">
      <div class="modal-content" style="width:100% !important;height: 600px;">
        ...
        border: none;">
          ...
          <h3 style="width:100%;text-align:center; color:#2b6699;"> Add Lead</h3>
...
<script>
    function add_education(){
      ...
      $('.add-class').append(` <div class="pt-3 scrollmenu row">
    <div class="col-md-2">
        <p>Qualification</p>
...
// $('.deletesameclassData').click (function(){
//     alert('test');
//     var dataaa = $(this).html();
//     console.log(dataaa);
// })
// });
 
// function delete_educationnn(){
    $(document).on('click','.deletesameclassData',function(){
