              ...
              <ul class="enquiry-test-list">
                <li>
                    {{-- <button type="button" class="" >
                        ...
                        <a href="{{route('add-leads')}}" class="collapse-item "><i class="fas fa-plus"></i> Add Lead  </a>
                      {{-- </button> --}}
                </li>
                <?php 
               ...
               $trash = DB::table('enquiries')->where('delete_client','0')->get();
                ?>  
                <li><a href={{ url('get-all-trash-clients') }}><i class="far fa-arrow-alt-circle-right"></i> {{$trash->count()}} Trashed   </a></li>
                <?php } ?>
    ...
    <div class="container-fluid my-3">
      ...
      <div class="col-md-2 col-xs-2 col-sm-12 col-lg-2 mb-3">
         <select id="Short by" name="shortby" type="text" value="" class="form-control" placeholder="Shortby" .required="">-->
                                <option type="checkbox" value="Short">Shortby*</option>
...
<!--</select>-->
      ...
      <div class="col-md-8 col-xs-8 col-sm-12 col-lg-8 " style=" text-align: end; ">
        <ul>
           <li class="btn-special btn-icon btn-googleplus" id="sendEmail"><i class="fa fa-file-excel-o" aria-hidden="true"></i><span data-href ="{{route('export')}}" onclick ="exportTasks(event.target);" id="export" style="padding-left: 5px; padding-right: 5px;" >Excel</span></li>
...
<div style="overflow-x:auto; height:300px;">
          ...
          <a style="color:#575757;" href="https://api.whatsapp.com/send?phone=91{{$s->contact}}&amp;text=Hello" target="_blank" style="color:#fff;">
            ...
            <span><a href="tel:{{$s->contact}}"><i style="width:15px; height:15px; font-size:12px; color:#25D366;" class="fa fa-phone" aria-hidden="true"></i></a></span>
          @endif
...
@endif
 ...
 {{-- <label class="container-radio">
          ...
          <a style="color:#575757;" href="https://api.whatsapp.com/send?phone=91{{$get2->contact}}&amp;text=Hello" target="_blank" style="color:#fff;">
               <img style="width:25px; height:25px;"  src="{{url('public/images/whatsapp2.jpg')}}"></a>
            <span><a href="tel:{{$get2->contact}}"><i style="font-size:15px; color:#25D366;" class="fa fa-phone" aria-hidden="true"></i></a></span>
          @endif
                       </p>
        ...
        <div class="modal-body">
         ...
         <div class="row">
           ...
           <div class="col-md-12 text-center" style="margin-top:10px;">
             ...
             <input type="submit" value="Send Mail" class="btn btn-danger w-10">
           </div>
           </div>
         </div>
        </form>
