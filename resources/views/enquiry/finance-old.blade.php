...
<div role="tabpane" class="tab-pane " id="get_fin{{$e->id}}">
    ...
    <div style="text-align: right"> 
        <button data-toggle="modal" data-target=".payment_edit{{$e->id}}" class="edit-text edit-button-design">Edit</button>
