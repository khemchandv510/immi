...
<?php $check_document_status = DB::table('enrolment_documents')->where('client_unique_id',session()->get('unique_id_sess'))->get(); ?>
                ...
                <td> 
                        <a href="{{url('public\uploads\documents/'.$c->document_name)}}" target="_blank">
                                <img src=" {{url('public\uploads\documents/'.$c->document_name)}}" alt=""> 
                        
                        </a>  
                        {{Form::hidden('quelification', url('public\uploads\documents/'.$c->document_name))}}
                </td>
                </tr>
                @endforeach
                @endif
