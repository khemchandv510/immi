...
$(document).ready(function(){
   ...
   {{ Form::open(array('url'=>'search', 'class' => 'enquiry-agent-name', "method" =>"get" )) }}
...
<!--</select>-->
    ...
    <!--  <span data-href="/tasks" id="export" class="btn btn-success btn-sm" onclick="exportTasks(event.target);">Export</span> --> 
          ...
          <li onclick ="" class="btn-special btn-icon btn-googleplus" id="send-sms"><i class="fa fa-user" aria-hidden="true" data-toggle="modal" data-target=""></i><span style="padding-left: 5px; padding-right: 5px;" data-toggle="modal" data-target="#asign_client" class="">Assign</span></li>
...
@if(Auth::user()->usertype_status != 4)
              ...
              <div class="dropdown">
               <i class="fa fa-caret-square-o-down" type="button" data-toggle="dropdown">
    </i>
                        <ul class="dropdown-menu pull-left statusdrop" name="" id="update_statu" class="form-control  update_status" onChane="update_status(this.value);"  data-id={{$get2->unique_id}} >
                            <li  selected value="{{$get2->disposition}}" disabled><a href="#"> {{$get2->disposition}}</a> </li>
                            @foreach($enq_status as $status4)
                            <li value="{{$status4->status}}"><a href="#"> {{$status4->status}}</a> </li>
                           @endforeach
                      </ul>
                     </div>    
...
<i class="fa fa-caret-square-o-down" type="button" data-toggle="dropdown">
    ...
    <ul class="dropdown-menu pull-left dropli update_status" name="conversion" id="conversion" onchane="update_status(this.value);">
    <li class="active"><a href="#" value="">Select Conversion</a></li>
      <li><a href="#" value="1">Student</a></li>
      <li><a href="#" value="2">PR/Immigration</a></li>
      <li><a href="#" value="3">Institute</a></li>
    </ul>
  </div>
...
<script>
 ...
 $(document).ready(function(){
                 ...
                 e.preventDefault();
              var form = $(this); 
                var url = "{{url('callbacklater')}}?a="+unique_id+"&comment="+comment+"&val="+val+"&callbacklater="+callbackdate+"&callbacklater_time="+callbacktime;
...
//$('.dropli').onchange(function(){
 //   $(this).find("#conversiondiv").toggle();
