           ...
           <div  class="modal fade {{'class'.$a->id}}" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content" style="width:600px !important">
                  <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                      <h4 class="modal-title">fsettretertertretert</h4>
                  </div>
                <div class="modal-body"> <img src="{{url('public\uploads\documents/'.$a->document_name)}}" alt="" style="width:100%"> </div>
                <div style="margin: 11px;
                padding: 3px;"> <button class="btn btn-danger remove-documents" data-id="{{$a->id}}"> Remove </button> 
            ...
            <a style="cursor:pointer"  class="{{'class'.$a->id}}" data-toggle="modal" data-target="{{'.class'.$a->id}}">  {{$a->document_name}}  </a>
