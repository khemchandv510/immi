...
<div class="container-fluid">
    <div class="leadhead">
        ...
        {{ Form::open(array('url'=>'admin/new-user' ,'files'=>'true')) }}
...
@foreach($status as $s)
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-address-book"></i></span>
                             ...
                             <!--<div class="col-md-4 py-3">-->
                             <div class="col-md-4 mt-3">
                                       <label for="">Source:<span style="color:red;">*</span></label>
...
?>
                                    <div class="col-md-4 mt-3">
                                       <label for="">Asign To Agent:<span style="color:red;">*</span></label>
...
<?php } ?>
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-address-book"></i></span>
    {!! Form::textarea('comment',null, array('class'=>'form-control','rows'=>"2", 'cols'=>"1")) !!} 
                                 </div>
                                 </div>
                                 </div>
...
.bootstrap-datetimepicker-widget.dropdown-menu .timepicker-picker table td button:hover {
  background-color: #eee;
                            ...
                            <!--        {{-- {!! Form::textarea('note', null, array('class'=>'form-control', 'rows'=>"3" ,'cols'=>"40", 'name' => 'note')) !!}  --}}-->
                            <!--        <?php   
                            // $purpose =  DB::table('enq_purposes')->select('purpose')->get() 
                            ?>-->
                            <!--        <select class="form-control" name="note">-->
                            <!--            <option selected="" disabled="">-Select-</option>-->
                            <!--            @foreach($purpose as $p)-->
                            ...
                            <!--          </select>-->
                            <!--          <?php
                            // echo ($errors->first('note',"<li class='custom-error'>:message</li>")) 
                            ?>-->
                            <!--</div>-->
