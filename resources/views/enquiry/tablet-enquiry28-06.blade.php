...
<html lang="en">
  <head>
    ...
    <title>Immigration Tablet From</title>
  </head>
  <body>
...
{{-- 
    ...
    <div id="dd1"  class="wrapper-dropdown" tabindex="1"><span>Purpose of Visit</span>
     ...
     <select name="gender" id="dd1" class="select  "  tabindex="1"  >
...
<!-- Education section starts here -->
 ...
 <div class="imm-card">
 	...
 	<div class="row edu-row">
      ...
      <select name="qualification_name[]" id="dd2" class="select"  tabindex="1"  >
 	...
 	<div class="row edu-row">
      ...
      <select name="imm_history[]" class="visa_rejected_country select  ">
       ...
       @endforeach
 				...
 				<div class="col-md-3">
 	   <label  class="inp">
       <input type="text" name="imm_history_from[]" placeholder="&nbsp;" id="imm-fromdate">
       ...
       <span class="border"></span>
 					...
 					<div class="col-md-3">
 	   <label  class="inp">
       <input type="text" name="imm_history_to[]" placeholder="&nbsp;" id="imm-todate">
       ...
       <span class="border"></span>
 				...
 				<div class="col-md-3">
 	   <label  class="inp">
       <input type="text" name="imm_history_duration[]" placeholder="&nbsp;">
       <span class="label">Duration<sup>*</sup></span>
       <span class="border"></span>
      </label>
 		</div>
...
<!-- course enrollment section starts here -->
 ...
 <div class="imm-card">
  ...
  <div class="row edu-row">
    ...
    <select name="visa_rejected_country[]" class="visa_rejected_country select  ">
        <option value="" disabled selected> Country</option>
        @foreach($countries as $c)
        <option value={{$c->country_name}}>  {{ $c->country_name }}</option>
     @endforeach
...
<!-- marital status section starts -->
 ...
 <div class="imm-card">
  ...
  <div class="col-md-3">
      <div><input type="radio" value="y" name="maritalradio" id="marriedinp" onclick="maritalshow()" /><label for="marriedinp">&nbsp;Married</label></div>
    </div>
   <div class="col-md-3">
...
<div class="text-left text-danger font-weight-bold"><small id="spouseincomemsg"></small></div>
    ...
    {{Form::submit('Save', array('id' =>"nextbtn10", 'class' => 'btn btn-success'))}}
    </div>
{{Form::close()}}
  </div>
  </div>
...
<div class="container imm-con-1 imm-education-dtl imm-financial-dtl imm-content imm-content11">
 ...
 <div class="imm-card">
 	...
 	<div class="row edu-row">
	  ...
	  <div class="imm-btngroup my-4">
	  <div><button type='button' class="btn btn-success" id="prevbtn11">Prev</button></div>
	  <div><button type='button' class="btn btn-success" id="nextbtn11">Next</button></div>
...
<script>
    ...
    $('#immi-options-append').append(' <div class="row edu-row"> <div class="col-md-3"> <select name="imm_history[]" class="visa_rejected_country select "> <option value="" disabled selected> Country</option> @foreach($countries as $c) <option value={{$c->country_name}}>{{$c->country_name}}</option> @endforeach </select> </div><div class="col-md-3"> <label class="inp"> <input type="text" name="imm_history_from[]" placeholder="&nbsp;" id="imm-fromdate"> <span class="label">From<sup>*</sup></span> <span class="border"></span> </label> </div><div class="col-md-3"> <label class="inp"> <input type="text" name="imm_history_to[]" placeholder="&nbsp;" id="imm-todate"> <span class="label">To<sup>*</sup></span> <span class="border"></span> </label> </div><div class="col-md-3"> <label class="inp"> <input type="text" name="imm_history_duration[]" placeholder="&nbsp;"> <span class="label">Duration<sup>*</sup></span> <span class="border"></span> </label> </div></div>');
