...
@if(($get->complete_application_form == "1") )
 <li class="list-group-control">
    <label class="custom-control material-checkbox ">
        <input type="checkbox" class="material-control-input " disabled checked>
        <span class="material-control-indicator"></span>
...
@else
 <li class="list-group-control">
    <label class="custom-control material-checkbox ">
        <input type="checkbox" class="material-control-input checked-activity" data-id="complete_application_form" id="{{$get->unique_id}}">
        <span class="material-control-indicator"></span>
        <span class="material-control-description">2.0 Complete Application Form</span>
    </label>
</li>
@endif
@if(($get->collect_document == "1") )
<li class="list-group-control">
    <label class="custom-control material-checkbox">
        <input type="checkbox" class="material-control-input" checked  disabled>
        <span class="material-control-indicator"></span>
    <span class="material-control-description"> 2.1 Collect Documents </span>
    </label>
</li>
@else
<li class="list-group-control">
    <label class="custom-control material-checkbox">
        <input type="checkbox" class="material-control-input checked-activity" data-id="collect_document" id="{{$get->unique_id}}">
        <span class="material-control-indicator"></span>
       <span class="material-control-description"> 2.1 Collect Document </span>
    </label>
</li>
@endif

@if(($get->review_apply == "1") )
<li class="list-group-control">
    <label class="custom-control material-checkbox">
        <input type="checkbox" class="material-control-input" checked  disabled>
        <span class="material-control-indicator"></span>
...
<li class="list-group-control">
    <label class="custom-control material-checkbox">
        <input type="checkbox" class="material-control-input checked-activity" data-id="review_apply" id="{{$get->unique_id}}">
        <span class="material-control-indicator"></span>
        <span class="material-control-description"> 2.2 Review  & Apply</span>
    </label>
</li>
...
<li class="list-group-control">
    <label class="custom-control material-checkbox">
        <input type="checkbox" class="material-control-input checked-activity" data-id="application_payment" id="{{$get->unique_id}}">
        <span class="material-control-indicator"></span>
        <span class="material-control-description"> 2.3 Application Payment (if required) </span>
    </label>
</li>
