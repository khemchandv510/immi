            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="row mgbt-xs-0">
                  ...
                  <div class="col-xs-7 controls">{{$enquiries[0]->state?Helper::getCountry($enquiries[0]->country):'Country'}}</div>
                  <!-- col-sm-10 --> 
                </div>
              </div>
              <div class="col-sm-6">
                <div class="row mgbt-xs-0">
                  ...
                  <div class="col-xs-7 controls">{{$enquiries[0]->state?helper::getState($enquiries[0]->state):'State'}}</div>
                  <!-- col-sm-10 --> 
                </div>
              </div>
              <div class="col-sm-6">
                <div class="row mgbt-xs-0">
                  ...
                  <div class="col-xs-7 controls">{{$enquiries[0]->pincode?$enquiries[0]->course:'Intrest'}}</div>
                  <!-- col-sm-10 --> 
                </div>
              </div>
              <div class="col-sm-6">
                <div class="row mgbt-xs-0">
                  ...
                  <div class="col-xs-7 controls">{{$enquiries[0]->country_of_birth?$enquiries[0]->country_of_birth:'Country Of Birth'}}</div>
                  <!-- col-sm-10 --> 
                </div>
              </div>
              <!--<div class="col-sm-6">-->
...
<td>{{$get->language}}</td>
{{-- <td>{{$get->language}}</td> --}}
<td> <?php if($get->language == "OET"){
  $a = json_decode($get->reading,false);
  echo$a[0]  .', '. $a[1];
}
else{
...
?></td>
<td> <?php if($get->language == "OET"){
  $a = json_decode($get->writing,false);
  echo$a[0]  .', '. $a[1];
}
else{
...
<td>
   <?php if($get->language == "OET"){
  $a = json_decode($get->speaking,false);
  echo$a[0]  .', '. $a[1];
}
else{
...
<td><?php if($get->language == "OET"){
  $a = json_decode($get->listening,false);
  echo$a[0]  .', '. $a[1];
}
else{
...
<td><a target ="_blank" href="{{url('public\uploads\documents\english-score/'.$get->upload_score_card)}}">{{$get->upload_score_card}}</a></td>
</tr>
...
<tr>
    ...
    <td>{{$get->language}}</td>
    <td>{{$get->gre_exam_date}}</td>
    <td>{{$get->gre_verbal_score}}, {{$get->gre_verbal_rank}}</td>
    <td>{{$get->gre_quantitative_score}}, {{$get->gre_quantitative_rank}}</td>
    <td>{{$get->gre_written_score}}, {{$get->gre_written_rank}}</td>
    <td>{{$get->gmat_total_score}}, {{$get->gmat_total_rank}}</td>
