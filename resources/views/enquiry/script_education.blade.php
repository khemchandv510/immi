...
if(data  == 0){
    ...
    $('#get_education_dynamic tr').css('background-color','#fff !important');
    $('#get_education_dynamic').append('<tr> <th>  Qualification </th> <td> <select name="name_of_class" class="form-control"> <?php $get_quelification=DB::table("highest_educations")->get(); foreach($get_quelification as $q){?> <option value="{{$q->education}}" >{{$q->education}}</option> <?php }?> </select> </td><td style="display:none"></td></tr><tr> <th>Examination Board </th> <td> <input type="text" name="education_name" value=""class="form-control " placeholder="Examination Board"> </td><td style="display:none"> </td></tr><tr> <th> Institute </th> <td> <input type="text" name="institute_name" value="" class="form-control" placeholder="Institute" > </td><td style="display:none"></td></tr><tr> <th> Start Date </th> <td> <input type="text" name="edu_start_date" value=""class="form-control date" placeholder="DD/MM/YYYY"> </td><td style="display:none"></td></tr><tr> <th>End Date</th> <td> <input type="text" name="edu_end_date" value="" class="form-control date" placeholder="DD/MM/YYYY"" > </td><td style="display:none"></td></tr><tr> <th> Duration </th> <td> <input type="text" name="course_duration" value=""class="form-control " placeholder="Duration"> </td><td style="display:none"></td></tr><tr> <th>Year of Award </th> <td> <input type="text" name="award_year" value=""class="form-control " placeholder="Year of Award"> </td><td style="display:none"></td></tr><tr> <th>Medium of Study </th> <td> <input type="text" name="study_medium" value=""class="form-control " placeholder="Medium of Study"> </td><td style="display:none"></td></tr><tr> <th> Mode of Study </th> <td> <input type="text" name="mode_of_study" value=""class="form-control " placeholder="Mode of Study"> </td><td style="display:none"></td></tr><tr> <th>Country of Study </th> <td> <input type="text" name="country_of_study" value=""class="form-control " placeholder="Country of Study"> </td><td style="display:none"></td></tr><tr> <th>State of Study</th> <td> <input type="text" name="state_of_study" value=""class="form-control " placeholder="State of Study"> </td><td style="display:none"></td></tr><tr> <th>City/Place of Study</th> <td> <input type="text" name="place_of_study" value="" class="form-control" placeholder="Place/City of Study"> </td><td style="display:none"></td></tr>    <tr>  <th>  <input type="hidden" name="unique_id" value="{{session()->get('unique_id_sess')}}"> </th><th style="display:block">   {{Form::submit("Saves", array("display" => "block"))}}</th></tr>     ') ;
