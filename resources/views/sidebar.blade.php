...
elseif (Request::segment(2) == "Missing-Requirements") {
  $page = 'Missing-Requirements';
}
...
<li class="nav-item @if($page == 'admin'){{'activess' }}@endif "> 
  ...
  <div id="admin" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded reg-form" id="reg_form">
      ...
      <!--{{url(Request::segment(1).'/'.'new-user')}}-->
      <a class="collapse-item" href="#" id="create_agent_button">Create  Agent</a>
...
<li class="nav-item @if($page == 'lead'){{'activess' }}@endif ">
  ...
  <div id="leads" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded reg-form" id="desk_en">
      ...
      <a class="collapse-item" href="{{url(Request::segment(1).'/'.'enquiry-list/'.Crypt::encrypt(Auth::user()->employee_id)) }}">View Leads</a>
      <a class="collapse-item" href="{{url(Request::segment(1).'/'.'dead-leads/'.Crypt::encrypt(Auth::user()->employee_id)) }}">Dead Leads</a>
       <a class="collapse-item" href="{{url(Request::segment(1).'/'.'lead-dashboard')}}" id="create_agent_button"> Leads Dashboard </a>
...
<li class="nav-item @if($page == 'institute'){{'activess' }}@endif ">
  ...
  <div id="institute" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded reg-form" id="desk_en">
      ...
      <a class="collapse-item" href="{{url(Request::segment(1).'/'.'institute-list')}}">View Student</a>
...
<li class="nav-item @if($page == 'Missing-Requirements'){{'activess' }}@endif ">
  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#institutes" aria-expanded="true" aria-controls="collapseTo">
  <i class="fas fa-school"></i>
    <span>Notification Manager</span>
  </a>
  <div id="institutes" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded reg-form" id="desk_en">
      <h6 class="collapse-header">Document missing</h6>
      <a class="collapse-item" href="{{url(Request::segment(1).'/'.'Missing-Requirements/')}}" id="create_agent_button"> Missing requirment</a>
      <a class="collapse-item" href="{{url(Request::segment(1).'/'.'MissignNotes/')}}">Notes</a>
      <a class="collapse-item" href="#" id="create_agent_button"> Task </a>
    </div>
  </div>
</li>
...
{{-- <li class="nav-item @if($page == 'subagent'){{'activess' }} @endif">
  <a class="nav-link collapsed" href="{{url('https://immigration.craftzvilla.com/imm/hrm/register') }}">
  <i class="far fa-list-alt"></i>
    <span>Create Sub Agents</span>
  </a>
</li> --}}
...
<li class="nav-item @if($page == 'subagent'){{'activess' }} @endif">
  <a class="nav-link collapsed" href="{{url('/hrm/register') }}">
  <i class="far fa-list-alt"></i>
    <span>Create Sub Agents</span>
  </a>
</li>
...
<li class="nav-item @if($page == 'hrm'){{'activess' }} @endif">
  <a class="nav-link collapsed" href="{{ url('/') }}/hrm/autologin?id={{ auth::user()->hrm_id }}&api_token={{$email}}">
    <i class="far fa-list-alt"></i>
    <span>HRM</span>
  </a>
</li>
...
<li class="nav-item @if($page == 'tash-management'){{'activess' }} @endif">
  <a class="nav-link collapsed" href="{{ url(Request::segment(1).'/task-management')}}">
    <i class="far fa-list-alt"></i>
...
<li class="nav-item @if($page == 'no urls'){{'activess' }}@endif">
  <a  href ="{{url(Request::segment(1).'/')}}"class="nav-link">
    <i class="fas fa-fw fa-tachometer-alt"></i>
    <span>Dashboard</span></a>
</li>
