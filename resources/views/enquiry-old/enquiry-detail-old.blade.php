...
.my-table th{
  ...
  /* tbody tr td:nth-child(3){padding:0 !important} */
  #st_detail{
      font-size: 13px;
  }
...
<td>
    ...
    <div class="client-detail-edit-button">
<button class="edit-button-design fa fa-detete" data-toggle="modal" data-target="#how_financial_edit{{$f->id}}">Edit</button>
    ...
    <tr>      <td colspan="3" >   <button type="button"  data-toggle="modal" data-target="#how_financial_edit">   + </button> </td></tr>
@else
...
<tr><td>
    ...
    {{Form::close()}}
        ...
        <a href="{{url('filter-course-section/?id='.session()->get('unique_id_sess'))}}">Create Application</a>
        </div>
...
<div class="modal" id="open_documents">
        ...
        <?php 
            ...
            <p> 
                ...
                <img src="http://digitaldwarka.com/taxiapp/adminimage/admin.png" alt=""style="width: 33px;
                border-radius: 26px;">
            ...
            <section class="son-msger">
                <header class="son-msger-header">
                  <div class="son-msger-header-title">
                    <i class="fa fa-comment-o"></i> SimpleChat
                  </div>
                ...
                <main class="son-msger-chat">
                  <div class="msg left-msg">
                    ...
                    <div class="son-msg-bubble">
                      <div class="son-msg-info">
                        <div class="son-msg-info-name">sonu</div>
                        <div class="son-msg-info-time">12:45</div>
                      </div>
                  ...
                  <div class="msg right-msg">
                    ...
                    <div class="son-msg-bubble">
                      <div class="son-msg-info">
                        <div class="son-msg-info-name">kaushik</div>
                        <div class="son-msg-info-time">12:46</div>
                      </div>
                ...
                <form class="son-msger-inputarea">
                  <input type="text" class="son-msger-input" placeholder="Enter your message...">
                  <button type="submit" class="son-msger-send-btn">Send</button>
                </form>
              </section>
        </div>
