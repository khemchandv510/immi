                              ...
                              <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>  <input type="text" name="name_on_passport" value="{{isset($get_passport[0]->name_on_id_proof)?$get_passport[0]->name_on_id_proof:''}}" class="form-control"> </td>
                                            </tr>
                                            ...
                                            <td> <input type="text" name="place_of_issue" value="{{isset($get_passport[0]->place_of_issue)?$get_passport[0]->place_of_issue:''}}" class="form-control"> </td>
                                                </tr>
                                <tr>
                                                <th> Date of Issue</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url("public/uploads/image/passport/".$get_passport[0]->id_image)}}" target="_blank"> <img style="width:80px;"  src={{url("public/uploads/image/passport/".$get_passport[0]->id_image)}} alt="">{{$get_passport[0]->id_image}} </a>
...
@else
        ...
        <td> <input type="text" class="date form-control" name="date_of_expiry_passport" placeholder="Date of Passport" > </td>
                </tr>
