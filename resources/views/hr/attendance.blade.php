...
<style type="text/css">
    table.attendancetable tr td {
        width: 25%;
        /*background-color: blue;*/
        /*border:1px solid red;*/
    }

    table.attendancetable tr th{
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="tab-content content-style active  my-4" id="attendance_page_tab">
                        ...
                        <div role="tabpane" class="tab-pane  active" id="attendance_today" style="width: 100%;margin:100px auto 0 auto;">
                        <table class="table table-hovered attendancetable" style="table-layout: fixed;width: 100%">
                                <thead>
                                <tr>
                                        <th>Id</th>
                                        <th>Name</th>
