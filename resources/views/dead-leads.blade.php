...
<script>
 ...
 <div class="container-fluid" style="padding:0">
    ...
    ></button> 
          ...
          <div class="row list-page-top-link panel" >
            ...
            // if( Auth::user()->usertype_status =='1'){
              ?> 
              {{-- <a href={{ url('asign-client-list') }}><li><i class="fas fa-user-tie"></i> Asigned Client  </li></a>  --}}
              <?php 
            // } 
            ?>
                ...
                <li><a href={{ url(Request::segment(1).'/'.'dead-leads/'.Crypt::encrypt(Auth::user()->employee_id)) }}><i class="fas fa-angle-double-right"></i>  Get All  </a></li>

                 <li>
                  <i class="fas fa-list-ul"></i> <span  class="priority-list-ul" style="padding:8px;">Priority List
                        <div class="hide-priority-list-ul">
                               <a href={{ url(Request::segment(1).'/'.'priority-list/1/dead-leads') }} value="1">   High  </a> 
                               <a href={{ url(Request::segment(1).'/'.'priority-list/2/dead-leads') }} value="2">   Medium  </a> 
                               <a href={{ url(Request::segment(1).'/'.'priority-list/3/dead-leads') }} value="3">   Low  </a> 
                              </div>
                                     </span>
                </li> 
 ...
 <!--<hr>-->
 {{ Form::open(array('url'=>url(Request::segment(1).'/'.'dead-leads'), 'class' => 'enquiry-agent-name', "method" =>"get" )) }}
...
@endif 
          ...
          <div class="col-md-12" style=" text-align: center; ">
              ...
              <a class="btn btn-danger w-10" href="{{url(Request::segment(1).'/'.'dead-leads') }}">Reset</a>
    ...
    <div class="col-md-8 col-xs-8 col-sm-12 col-lg-8 " style=" text-align: end; ">
      <ul>
        <script>
          ...
          @if(Auth::user()->usertype_status == 1)
           <li class="btn-special btn-icon btn-googleplus" onclick="BulkDelete(event.target)" id="bulkDelete"><i class="fa fa-trash" aria-hidden="true"></i><span id="" style="padding-left: 5px; padding-right: 5px;" >Bulk Delete</span></li>
            @endif
...
<center> <h2 class="text-primary" style="margin-top:-40px;">Dead Leads </h2></center>
...
<table class="display table table-hover table-responsive-md table-responsive-lg table-responsive-sm table-responsive-xs" id="example" cellspacing="0" width="100%">
    ...
    <tbody>
        ...
        <td>
          {{$get->country?Helper::getCountry($get->country):''}}  
