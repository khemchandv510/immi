...
//    }
 ...
 public function insert_institution(Request $request){
    ...
    $newfilename = $unique_id.".".$request->file('logo')->getClientOriginalExtension();
    $getcheck=$request->file("logo")->move(public_path('uploads/university-logo'), $newfilename);
  ...
  //  $legal_name = $request->input('legal_name');
    ...
    $landline  = $request->input('landline');
      ...
      return redirect('admin/education/dashboard');
 }
...
public function DeleteIntCourses(Request $request){
   $id = $request->id;
   $id = Crypt::decrypt($id);
  
   $courses = DB::table('courses')->where('college_code', $id)->delete();
   
   $get_institutes  = DB::table('my_institutes')->where('code',$id)->delete();
   
   return redirect('admin/education/dashboard#start');
//   return view('education/update-institution' , ['get_institutes' => $get_institutes]);
}
