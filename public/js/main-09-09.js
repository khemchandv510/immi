...
function show_agent_more_feild() {
	...
	// var button = document.getElementsByName('agent-more-feild').innerHTML = "sdfsd";
...
function show_all_program(){
	var a = $('.program-filter:visible').height();
	// alert(a);
	if(a < '500'){
	$('.view-more-button').click(function(){
			$(this).parent().parent().height('500px');
		// $('.filter-list-parent .program-filter').height('500px');
...
document.getElementById('files1').setAttribute("disabled", "");
// document.getElementById('files2').setAttribute("disabled", "");
// document.getElementById('files3').setAttribute("disabled", "");
// document.getElementById('files4').setAttribute("disabled", "");
// document.getElementById('files5').setAttribute("disabled", "");
// document.getElementById('files6').setAttribute("disabled", "");
// document.getElementById('files7').setAttribute("disabled", "");
    ...
    if (window.File && window.FileList && window.FileReader) {
        ...
        for (var i = 0; i < files.length; i++) {
            ...
            picReader.addEventListener("load", function (event) {
                ...
                div.innerHTML += "<img  class='thumbnail' src='" + picFile.result + "'" + "ti='" + a + "'/>";
    ...
    if (window.File && window.FileList && window.FileReader) {
        ...
        for (var i = 0; i < files.length; i++) {
            ...
            picReader.addEventListener("load", function (event) {
                ...
                var div = document.createElement("div");
                var hol = document.createElement("div");
                div.innerHTML += "<img  class='thumbnail' src='" + picFile.result + "'" + "title='" + a+ "'/>";
                                output.insertBefore(div, null);
                });
            picReader.readAsDataURL(file);
            } 
